...
import com.sena.springecommerce.repo.IOrdenRepository;
...
public class OrdenServiceImplement implements IOrdenService {
	...
	@Override
	public List<Orden> FinUsuario(Usuario usuario) {
		// TODO Auto-generated method stub
		return ordenRepository.f;
	}
	...
	@Override
	public String generarNumero_Orden() {
		// TODO Auto-generated method stub
		return null;
	}
